...
$packageArgs                = @{
    ...
    fileType                = 'exe'
    url                     = 'https://download.microsoft.com/download/2/7/A/27AF1BE6-DD20-4CB4-B154-EBAB8A7D4A7E/officedeploymenttool_11901-20022.exe'
    checksum                = 'A04A7C7DEFAD116E4CAB15C682781229C660FF9CB91EEBBF16D1BE7B0E4E5531'
    checksumType            = 'sha256'
