...
$packageArgs                = @{
    ...
    fileType                = 'exe'
    url                     = 'https://download.microsoft.com/download/6c1eeb25-cf8b-41d9-8d0d-cc1dbc032140/officedeploymenttool_19628-20046.exe'
    checksum                = '5ddd5e6dd7fe266c56d5eb9d543b454dc7af28a5b33caa8c1ac8d6e92c038653'
    checksumType            = 'sha256'
