...
$packageArgs                = @{
    ...
    fileType                = 'exe'
    url                     = 'https://download.microsoft.com/download/2/7/A/27AF1BE6-DD20-4CB4-B154-EBAB8A7D4A7E/officedeploymenttool_14729-20228.exe'
    checksum                = 'ebb8a4843ad5e33564dbdfeea6f44c22a0df853ac65c3e17b3b3b7b5ddf6cfe2'
    checksumType            = 'sha256'
