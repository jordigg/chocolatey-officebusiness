...
$packageArgs                = @{
    ...
    fileType                = 'exe'
    url                     = 'https://download.microsoft.com/download/2/7/A/27AF1BE6-DD20-4CB4-B154-EBAB8A7D4A7E/officedeploymenttool_13901-20336.exe'
    checksum                = '41acc3ed91cf3017702a543b52cd5050a2e0087ed805947d550f061ff52949ec'
    checksumType            = 'sha256'
