...
$packageArgs                = @{
    ...
    fileType                = 'exe'
    url                     = 'https://download.microsoft.com/download/6c1eeb25-cf8b-41d9-8d0d-cc1dbc032140/officedeploymenttool_19628-20192.exe'
    checksum                = '52e3bd4dc386dde60e88395b5372d595fa7178547ab2e47c699dd6d07995e413'
    checksumType            = 'sha256'
