...
$packageArgs                = @{
    ...
    fileType                = 'exe'
    url                     = 'https://download.microsoft.com/download/6c1eeb25-cf8b-41d9-8d0d-cc1dbc032140/officedeploymenttool_19029-20278.exe'
    checksum                = '6cda90dd52f0efee142c65a087ef74601722eacddb3607b81ddbeafc8cd79fea'
    checksumType            = 'sha256'
