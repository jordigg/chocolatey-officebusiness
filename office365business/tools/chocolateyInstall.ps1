...
$packageArgs                = @{
    ...
    fileType                = 'exe'
    url                     = 'https://download.microsoft.com/download/2/7/A/27AF1BE6-DD20-4CB4-B154-EBAB8A7D4A7E/officedeploymenttool_16731-20290.exe'
    checksum                = '613bd0952064cef8b65335a9c50c435d5e2eda5d7a6d0ea120806103c72bde32'
    checksumType            = 'sha256'
