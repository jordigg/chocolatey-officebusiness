...
$packageArgs                = @{
    ...
    fileType                = 'exe'
    url                     = 'https://download.microsoft.com/download/2/7/A/27AF1BE6-DD20-4CB4-B154-EBAB8A7D4A7E/officedeploymenttool_10810.33603.exe'
    checksum                = '806478D5ABE935D0D8E636898C929570C5256E1E8C55BC17DE717290ED19D023'
    checksumType            = 'sha256'
