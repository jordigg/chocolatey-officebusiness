...
$packageArgs                = @{
    ...
    fileType                = 'exe'
    url                     = 'https://download.microsoft.com/download/2/7/A/27AF1BE6-DD20-4CB4-B154-EBAB8A7D4A7E/officedeploymenttool_16529-20182.exe'
    checksum                = 'b91d7f154a9fc1157e34178569c26594037523b76bf7e68132d92e174d10510d'
    checksumType            = 'sha256'
