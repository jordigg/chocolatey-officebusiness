...
$packageArgs                = @{
    ...
    fileType                = 'exe'
    url                     = 'https://download.microsoft.com/download/2/7/A/27AF1BE6-DD20-4CB4-B154-EBAB8A7D4A7E/officedeploymenttool_15028-20160.exe'
    checksum                = 'b408e5fe8221bd22ad9b8d864be5621693b001d3859d9dc1e75bb42c5fed70d0'
    checksumType            = 'sha256'
